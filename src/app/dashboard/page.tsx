                    ...
                    <div className="flex flex-col gap-3">
                        {loading ? (
                            ...
                            sessions.slice(0, 6).map((session: any) => (
                                <Link key={session.id} href={`/dashboard/analyze?sessionId=${session.id}`} className="group flex items-center justify-between p-4 sm:p-5 bg-white border border-slate-100 rounded-2xl hover:border-purple-300 hover:shadow-lg hover:shadow-purple-500/10 transition-all">
