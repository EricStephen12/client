        ...
        <div className="max-w-6xl mx-auto space-y-12 md:space-y-20">
                ...
                <RevealOnScroll>
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-slate-100 pb-12">
                        <div className="space-y-4">
                            <span className="text-[10px] font-bold uppercase tracking-[0.4em] text-purple-600 mb-2 block">Director's Suite</span>
                        ...
                        {profile?.plan_type && profile.plan_type !== 'free' && (
                            <div className="flex items-center gap-3 bg-purple-50 border border-purple-100 px-6 py-3 rounded-2xl">
            ...
            <RevealOnScroll delay={200}>
                <div className="bg-gradient-to-br from-indigo-950 via-purple-950 to-slate-900 rounded-[3rem] p-10 md:p-20 text-white relative overflow-hidden group shadow-2xl border border-purple-500/10">
                    <div className="absolute top-0 right-0 p-12 opacity-5 font-sans font-bold text-[15vw] pointer-events-none text-purple-200">FLOW</div>
                    
                    <div className="max-w-2xl relative z-10 space-y-10">
                        <div className="space-y-6">
                            <h3 className="text-3xl md:text-5xl font-serif italic text-purple-200 leading-tight">
                        ...
                        <div className="flex flex-col sm:flex-row gap-6">
                            <Link
                                ...
                                className="px-10 py-6 bg-purple-500 text-slate-950 rounded-2xl font-bold uppercase tracking-widest text-xs hover:bg-white hover:scale-105 transition-all shadow-xl shadow-purple-950/20 text-center"
                            >
                    ...
                    {/* Aesthetic Glow */}
                    <div className="absolute -bottom-24 -right-24 w-96 h-96 bg-purple-500 rounded-full blur-[140px] opacity-10" />
                </div>
            </RevealOnScroll>
                ...
                {[
                    ...
                    <RevealOnScroll key={i} delay={300 + (i * 100)}>
                        <div className="p-8 bg-white border border-slate-100 rounded-[2rem] hover:shadow-lg transition-all group">
                            <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-slate-400 mb-4 group-hover:text-purple-600 transition-colors">{stat.label}</p>
