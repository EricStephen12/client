        ...
        <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-lime-100 selection:text-lime-900">
            ...
            <nav className="fixed w-full z-50 bg-white/80 backdrop-blur-md border-b border-slate-100">
                <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                    ...
                    <div className="flex gap-10 text-[10px] font-bold tracking-[0.3em] uppercase text-slate-400">
                        ...
                        <Link href="/login" className="hover:text-lime-600 transition-colors">Sign In</Link>
                    </div>
                </div>
            </nav>
            ...
            <main className="max-w-7xl mx-auto px-6 pt-40 pb-32">
                <div className="text-center mb-32">
                    <RevealOnScroll>
                        <span className="text-[10px] font-bold tracking-[0.5em] uppercase text-lime-600 mb-6 block">The Investment</span>
                        <h1 className="text-5xl md:text-7xl font-sans font-bold tracking-tight text-slate-900 mb-8">
                            ...
                            <span className="italic text-transparent bg-gradient-to-r from-lime-600 to-lime-500 bg-clip-text underline decoration-lime-100 underline-offset-8">creative cycle.</span>
                        </h1>
                ...
                <div className="mt-32 text-center max-w-2xl mx-auto border-t border-slate-100 pt-20">
                    <span className="text-[10px] font-bold tracking-[0.3em] uppercase text-lime-600 mb-4 block">The Founding Promise</span>
...
<footer className="bg-white border-t border-slate-100 py-24 px-6">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-16">
                    <Link href="/" className="text-2xl font-serif italic font-bold text-slate-900 opacity-60 hover:opacity-100 transition-opacity">Eixora<span className="text-lime-600">.</span></Link>
                    <div className="flex flex-wrap justify-center gap-12 text-[9px] font-bold tracking-[0.4em] uppercase text-slate-400">
                        <Link href="/privacy" className="hover:text-lime-600 transition-colors">Privacy</Link>
                        <Link href="/terms" className="hover:text-lime-600 transition-colors">Terms</Link>
                        <a href="mailto:hello@eixora.store" className="hover:text-lime-600 transition-colors">Support</a>
                    </div>
