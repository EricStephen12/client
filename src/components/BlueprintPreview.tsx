            ...
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-24">
                    ...
                    <h2 className="text-4xl md:text-6xl font-sans font-bold tracking-tight text-slate-900 mb-6">
                        ...
                        <span className="text-transparent bg-gradient-to-r from-purple-600 to-amber-500 bg-clip-text underline decoration-amber-100 decoration-8 underline-offset-8">create with confidence.</span>
                    </h2>
                        ...
                        <div className="grid lg:grid-cols-12">
                            ...
                            <div className="lg:col-span-4 p-10 md:p-16 border-b lg:border-b-0 lg:border-r border-purple-50 flex flex-col justify-center">
                                <div className="space-y-12">
                                    ...
                                    <div className="group">
                                        <h3 className="text-xl font-bold text-slate-900 mb-4 group-hover:text-amber-500 transition-colors">Shared Success</h3>
                                        <p className="text-sm text-slate-500 leading-relaxed">
                                ...
                                <div className="bg-white border border-purple-100/50 rounded-2xl shadow-2xl overflow-hidden min-h-[500px] flex flex-col">
                                    ...
                                    <div className="p-10 flex-grow">
                                        <div className="flex justify-between items-start mb-12">
                                            ...
                                            <div className="bg-amber-50 text-amber-700 px-4 py-2 rounded-full text-[10px] font-bold uppercase tracking-widest">
                                                Empathy Score: 92%
                                            </div>
                                        </div>
                                        ...
                                        <div className="grid md:grid-cols-2 gap-10">
                                            <div className="space-y-8">
                                                <div className="p-6 bg-white rounded-2xl border border-purple-100 shadow-sm">
                                                    ...
                                                    <div className="flex gap-4">
                                                        <div className="w-12 h-12 bg-amber-50 rounded-lg flex-shrink-0 flex items-center justify-center text-amber-600">
                                                ...
                                                <div className="p-6 bg-indigo-950 rounded-2xl text-white shadow-lg">
                                                    <p className="text-[10px] font-bold uppercase tracking-widest text-amber-400 mb-4">The Hook Guide</p>
                                            ...
                                            <div className="flex flex-col justify-end">
                                                <div className="bg-white border border-purple-100 p-8 rounded-3xl text-slate-900 shadow-sm relative overflow-hidden group">
                                                    ...
                                                    <h4 className="text-[10px] font-bold uppercase tracking-widest text-amber-600 mb-4">A Note on Connection</h4>
